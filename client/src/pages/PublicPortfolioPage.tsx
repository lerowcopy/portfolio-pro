...
export default function PublicPortfolioPage() {
  ...
  const portfolio: PreviewPortfolio = { title: query.data.title, bio: query.data.bio, logoUrl: query.data.logoUrl, avatarUrl: query.data.avatarUrl, socialLinks: query.data.socialLinks, template: query.data.template, colorScheme: query.data.colorScheme, fontFamily: query.data.fontFamily, projects: query.data.projects, services: query.data.services, posts: query.data.posts, contactEmail: query.data.contactEmail };
