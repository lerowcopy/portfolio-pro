...
const templateLabels = { minimal: "Minimal", gallery: "Gallery", cards: "Cards", blog: "Blog" } as const;
const colorLabels = { blue: "Blue", dark: "Dark", purple: "Purple", green: "Green" } as const;
const fontLabels = { inter: "Inter", playfair: "Playfair", georgia: "Georgia" } as const;

function toFormValues(portfolio: PortfolioInput): PortfolioInput { return { ...portfolio }; }
...
function PortfolioEditor({ portfolioId, initialValues }: { portfolioId: number; initialValues: PortfolioInput }) {
  ...
  }, [form, portfolioId, update, utils.portfolios.list]);
